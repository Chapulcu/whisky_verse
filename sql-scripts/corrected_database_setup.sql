-- Complete Database Setup Script for Whisky Community (Corrected)
...
-- Step 4: Insert premium whisky data (without specifying id, letting PostgreSQL generate UUIDs)
